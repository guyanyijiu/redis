...
use guyanyijiu\Redis\Connections\PhpRedisConnection;
use guyanyijiu\Redis\Connections\PhpRedisClusterConnection;
...
class PhpRedisConnector
{
     ...
     * @param  array  $config
     * @param  array  $options
     * @return \guyanyijiu\Redis\PhpRedisConnection
     */
     ...
     * @param  array  $options
     * @return \guyanyijiu\Redis\Connections\PhpRedisClusterConnection
     */
